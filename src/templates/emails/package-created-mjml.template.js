...
module.exports = (data) => {
  ...
  const content = `
    ...
    <mj-section background-color="#FFFFFF" padding="0 0 30px 0">
      <mj-column>
        <mj-wrapper background-color="#F8FAFC" border="1px solid #E2E8F0" border-radius="12px" padding="0" css-class="transaction-details">
          <!-- Header -->
          <mj-section background-color="#0052CC" border-radius="12px 12px 0 0" padding="20px 30px">
            <mj-column>
            ...
            <mj-column>
              <mj-table>
                <tr style="border-bottom: 1px solid #E5E7EB;">
                  ...
                  <td style="padding: 12px 0; color: #0052CC; font-weight: 600; text-align: right;">${packageName}</td>
                </tr>
                <tr style="border-bottom: 1px solid #E5E7EB;">
                  <td style="padding: 12px 0; font-weight: 600; color: #374151;">Principal Amount:</td>
                  <td style="padding: 12px 0; color: #059669; font-weight: 700; text-align: right; font-size: 18px;">₦${amount ? amount.toLocaleString() : '0'}</td>
                </tr>
                <tr style="border-bottom: 1px solid #E5E7EB;">
    ...
    <!-- Support -->
    <mj-text font-size="14px" color="#6B7280" align="center" line-height="1.6" padding="30px 0 0 0">
    ...
    <mj-section background-color="#FFFFFF" padding="30px 0 0 0">
      <mj-column>
        <mj-text font-size="18px" font-weight="600" color="#059669" align="center" padding="0 0 10px 0">
  ...
  return baseMjmlTemplate(content, {
    ...
    headerColor: '#059669', // Green header for success
    showLogo: true,
    cta: dashboardUrl ? {
