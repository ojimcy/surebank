...
module.exports = (data) => {
  const content = `
    ...
    <mj-text font-size="15px" color="#10B981" padding="30px 0 0 0">
      <strong>Funds Transferred Successfully</strong><br/>
      The amount has been successfully transferred to your bank account.
    ...
    <mj-section background-color="#F8FAFC" padding="20px" border-radius="8px" margin="30px 0 0 0">
      <mj-column>
        <mj-text font-size="14px" color="#4B5563">
          Please keep this email for your records. It serves as confirmation of your successful withdrawal.
        </mj-text>
      </mj-column>
    </mj-section>
  ...
  return baseMjmlTemplate(content, {
    title: 'Withdrawal Successful - SureBank',
    preheader: `Your withdrawal of ₦${(data.amount || 0).toLocaleString()} was successful`,
