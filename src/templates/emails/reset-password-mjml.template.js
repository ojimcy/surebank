...
module.exports = (data) => {
  ...
  const content = `
    ...
    <mj-section background-color="#FFFFFF" padding="0 0 30px 0">
      <mj-column>
        <mj-wrapper background-color="#F8FAFC" border="2px solid #E2E8F0" border-radius="12px" padding="30px 20px">
          ...
          <mj-text color="#EF4444" font-size="14px" font-weight="600" align="center" padding="10px 0 0 0">
    ...
    <mj-section background-color="#FFFFFF" padding="0 0 30px 0">
      <mj-column>
        <mj-wrapper background-color="#FEF2F2" border-left="4px solid #EF4444" border-radius="6px" padding="20px" css-class="alert-danger">
          <mj-text font-size="16px" font-weight="600" color="#EF4444" align="left" padding="0 0 15px 0">
    ...
    <!-- Support -->
    <mj-text font-size="14px" color="#64748b" align="center" line-height="1.6" padding="20px 0 0 0">
