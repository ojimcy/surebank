...
import { Row, Col, Badge, Button, Portlet, Dropdown } from '@blueupcode/components'
...
const PortletBasePage: ExtendedNextPage = () => {
	return (
		<Row>
			<Col md="6">
				{/* BEGIN Portlet */}
						...
						<Portlet.Addon>
							...
							<Dropdown>
								...
								<Dropdown.Menu animated align="end">
									<Dropdown.Item icon={<FontAwesomeIcon icon={faRocket} />}>Action</Dropdown.Item>
									<Dropdown.Item icon={<FontAwesomeIcon icon={faComments} />}>Another action</Dropdown.Item>
									<Dropdown.Item icon={<FontAwesomeIcon icon={faPaperPlane} />}>Something else here</Dropdown.Item>
								</Dropdown.Menu>
							</Dropdown>
							{/* END Dropdown */}
						</Portlet.Addon>
			...
			<Col md="6">
				...
				<Portlet>
					...
					<Portlet.Body>
						...
						<Portlet>
							...
							<Portlet.Footer bordered align="start">
								<Button variant="primary">Submit</Button> <Button variant="outline-secondary">Cancel</Button>
							</Portlet.Footer>
						</Portlet>
						{/* END Portlet */}
				...
				<Portlet variant="primary">
					...
					<Portlet.Footer>
						<Button variant="success">Submit</Button> <Button variant="text-light">Cancel</Button>
					</Portlet.Footer>
				</Portlet>
				{/* END Portlet */}
				{/* BEGIN Portlet */}
				<Portlet variant="success">
					...
					<Portlet.Footer>
						<Button variant="primary">Submit</Button> <Button variant="text-light">Cancel</Button>
					</Portlet.Footer>
				</Portlet>
				{/* END Portlet */}
			</Col>
...
PortletBasePage.pageTitle = 'Portlet'
PortletBasePage.activeLink = 'elements.portlet.base'
PortletBasePage.breadcrumb = [
	{ text: 'Dashboard', link: '/' },
	{ text: 'Portlet' },
	{ text: 'Base', link: '/portlet/base' },
]

export default withAuth(PortletBasePage)
