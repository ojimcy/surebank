...
const EditorComplexPage: ExtendedNextPage = () => {
		...
		<Row>
			<Col>
				...
				<Portlet>
					...
					<Portlet.Body>
						<ReactQuill theme="snow" defaultValue={content} onChange={handleChange} modules={modules} />
					</Portlet.Body>
				</Portlet>
				{/* END Portlet */}
			</Col>
...
EditorComplexPage.pageTitle = 'Complex Editor'
EditorComplexPage.activeLink = 'form.editor.complex'
EditorComplexPage.breadcrumb = [
	{ text: 'Dashboard', link: '/' },
	{ text: 'Editor' },
	{ text: 'Complex', link: '/editor/complex' },
]

export default withAuth(EditorComplexPage)
