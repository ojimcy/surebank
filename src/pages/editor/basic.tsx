...
const EditorBasicPage: ExtendedNextPage = () => {
		...
		<Row>
			<Col>
				...
				<Portlet>
					...
					<Portlet.Body>
						<ReactQuill theme="snow" defaultValue={content} onChange={handleChange} />
					</Portlet.Body>
				</Portlet>
				{/* END Portlet */}
			</Col>
...
EditorBasicPage.pageTitle = 'Basic Editor'
EditorBasicPage.activeLink = 'form.editor.basic'
EditorBasicPage.breadcrumb = [
	{ text: 'Dashboard', link: '/' },
	{ text: 'Editor' },
