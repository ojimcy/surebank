...
const WidgetsGeneralPage: ExtendedNextPage = () => {
	return (
		<>
			<Row portletFill="xl">
				<Col xl="4">
...
WidgetsGeneralPage.pageTitle = 'General Widget'
WidgetsGeneralPage.activeLink = 'elements.widgets.general'
WidgetsGeneralPage.breadcrumb = [
	{ text: 'Dashboard', link: '/' },
	{ text: 'Widgets' },
	{ text: 'General', link: '/widgets/general' },
]

export default withAuth(WidgetsGeneralPage)
